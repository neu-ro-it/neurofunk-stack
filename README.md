...
```sh
pnpm dlx create-remix@latest --template neu-ro-it/neurofunk-remix
or
pnpm dlx create-remix@latest --template neu-ro-it/neurofunk-remix
```
...
- 🗺️[Multi-region Fly app deployment](https://fly.io/docs/reference/scaling/) with 🐋[Docker](https://www.docker.com/)
...
- ✅Linting with [ESLint](https://eslint.org) and [Markdown Lint](https://github.com/DavidAnson/vscode-markdownlint)
...
[![Gitpod Ready-to-Code](https://img.shields.io/badge/Gitpod-Ready--to--Code-blue?logo=gitpod)](https://gitpod.io/#https://github.com/neu-ro-it/neurofunk-stack/tree/main)
...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create neurofunk-remix
  fly apps create neurofunk-stage
  ```
